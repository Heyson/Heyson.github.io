<?php
		  ...
		  if ($ad_to_show->file) {
			if ($ad_to_show->type != 'swf') {
			  $ad_output = "<a href=\"http://rumorboston.com/sitetools/ads/ad_redirect.php?id={$ad_id}\" target=\"_blank\"><img src=\"http://pashaboston.com/site_admin/files/ads/{$ad_to_show->file}\" border=\"0\" /></a>";
			} else {
			  $ad_output = "object";
			}
		  } else {
